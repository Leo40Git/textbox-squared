...
import adudecalledleo.tbsquared.render.composite.FaceRenderer;
...
public abstract class SingleFacePositionRenderer implements FaceRenderer {
    ...
    @Override
    public Point renderFaces(Graphics2D g, Map<FacePosition, Face> faces, int x, int y) {
        ...
        return renderFace(g, face, x, y);
    }

    protected abstract Point renderFace(Graphics2D g, Face face, int x, int y);
}
